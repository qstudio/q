...
class group extends \q\context {
    ...
    public static function get( $args = null ) {
		...
		if ( 
			...
			render::$args['fields'] = $array['fields']; 
    ...
    public static function get_NO( $args = null ) {
        ...
        if ( 
			...
			// log ##
			h::log( render::$args['task'].'~>e:Error in passed parameter $args');
        ...
        $array = array_column( render::$args[ 'fields' ], 'name' );
        ...
        if ( 
			...
			// log ##
			h::log( render::$args['task'].'~>e:Error extracting field list from passed data');
        ...
        if ( 
			...
			// log ##
			h::log( render::$args['task'].'~>n:Fields array is empty, so nothing to process...');
