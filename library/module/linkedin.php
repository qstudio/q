...
class linkedin extends \Q {
    ...
    public static function run()
    {
		...
		\q\module::filter([
			...
			'name'		=> 'Q ~ Linkedin Tag Manager ( See Analytics and Marketing section )',
			'selected'	=> true,
		]);
		...
		if ( 
			! isset( core\option::get('module')->linkedin )
			|| true !== core\option::get('module')->linkedin 
		){
