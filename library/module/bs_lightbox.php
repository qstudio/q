...
// load it up ##
\q\module\bs_lightbox::__run();

class bs_lightbox extends \Q {
    ...
    public static function __run()
    {
		...
		if ( 
			! isset( core\option::get('module')->bs_lightbox )
			|| true !== core\option::get('module')->bs_lightbox 
		){

			h::log( 'd:>Lightbox is not enabled.' );
        ...
        \add_action( 'wp_footer', function(){
		 ...
		 // add js instigate to theme ##
		 \add_action( 'wp_footer', function(){
			asset\javascript::ob_get([
				'view'      => get_class(), 
				'method'    => 'javascript_init',
			]);
		}, 3 );
    ...
    public static function filter_acf_module( $field )
    {
		...
		// pop on a new choice ##
		$field['choices']['bs_lightbox'] = 'Bootstrap Lightbox';

		// make it selected ##
		$field['default_value'][0] = 'bs_lightbox';
...
<?php
    ...
    /**
    * Instigate BS lightbox
	*
	* @link 	https://ashleydw.github.io/lightbox
    * @since    2.0.0
    * @return   String HTML
    */
    public static function javascript_init( $args = null )
    {
...
?>
<style>
/* Credits: https://ashleydw.github.io/lightbox */
.ekko-lightbox {
