...
// namespace q\theme\ui\navigation;
// @link -- https://github.com/wp-bootstrap/wp-bootstrap-navwalker/blob/master/class-wp-bootstrap-navwalker.php

/* Check if Class Exists. */
if ( ! class_exists( 'Q_Nav_Walker' ) ) {
	
	class Q_Nav_Walker extends Walker_Nav_Menu {
