...
// load it up ##
\q\module\bootstrap_helper::__run();

class bootstrap_helper extends \Q {
    ...
    public static function __run()
    {
		...
		if ( 
			! isset( core\option::get('module')->bootstrap_helper )
			|| true !== core\option::get('module')->bootstrap_helper 
		){
	...
	public static function html(){
		...
		if( 
			...
			h::log( 'd:>BootStrap Helper is disabled when debugging is disabled...' );
