...
class asana extends \Q {
    ...
    public static function __run()
    {
		...
		if ( 
			! isset( core\option::get('module')->asana )
			|| true !== core\option::get('module')->asana 
		){
    ...
    public static function create_task( Array $args = null )
    {
        ...
        switch ( $args['method'] ) {
            ...
            case "api" :
                ...
                helper::log( 'No API endpoints available.' );
