...
// load it up ##
\q\module\bootstrap_gallery::__run();

class bootstrap_gallery extends \Q {
    ...
    public static function __run()
    {
		...
		if ( 
			! isset( core\option::get('module')->bootstrap_gallery )
			|| true !== core\option::get('module')->bootstrap_gallery 
		){
