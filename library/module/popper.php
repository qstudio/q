...
// load it up ##
\q\module\popper::__run();

class popper extends \Q {
    ...
    public static function __run()
    {
		...
		if ( 
			! isset( core\option::get('module')->popper )
			|| true !== core\option::get('module')->popper 
		){
    ...
    public static function filter_acf_module( $field )
    {
		...
		// pop on a new choice ##
		$field['choices']['popper'] = 'Popper JS';

		// make it selected ##
		$field['default_value'][0] = 'popper';
