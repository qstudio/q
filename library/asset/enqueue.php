		...
		*/
        if ( 
			...
			\wp_localize_script( 
				...
				array_merge( 
					array(
						'ajaxurl'           => \admin_url( 'admin-ajax.php' ), // available @ q_module.ajaxurl
						'debug'             => self::$debug, // available @ q_module.debug
						'nonce'             => \wp_create_nonce( 'q_module_nonce' ), // available @ q_module.nonce
					), 
