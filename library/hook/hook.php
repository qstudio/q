...
//               \wp_enqueue_style( 'bootstrap-grid' );
            ...
            // Gravity Forms ##
            if ( \q_plugin_is_active( 'gravityforms/gravityforms.php' ) && self::$options->plugin_css === TRUE ) {
            ...
            // tubepress ##
            if ( ( \q_plugin_is_active( 'tubepress/tubepress.php' ) || \q_plugin_is_active( 'tubepress_pro/tubepress.php') ) && self::$options->plugin_css === TRUE ) {
            ...
            // mailchimp ##
            if ( \q_plugin_is_active( 'mailchimp/mailchimp.php' ) && self::$options->plugin_css === TRUE ) {
