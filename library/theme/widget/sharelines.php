...
class sharelines extends \Q {
    ...
    */
    public static function assets()
    {
        ...
        \wp_register_style( 'q-sharelines-css', helper::get( "theme/css/widget.sharelines.css", 'return' ) );
...
?>
                <li class="item" data-shareline="<?php echo \esc_js( $shareline ); ?>">
                    ...
                    <span class="text"><span class="fade"></span><?php echo generic::chop( $shareline, 140 ); ?></span>
...
<?php
        ...
        // add javascript ##
        generic::minify( self::javascript() );
