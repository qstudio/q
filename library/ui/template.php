...
class template {
    ...
    */
    ...
    public static function track( $option = 'status', $template = null ){
        ...
        switch ( $option ) {
            ...
            case "status" :
                ...
                // h::log( 'Checking Tracker: '.( ! is_null( self::$template_tracker ) ? self::$template_tracker : 'null' ) );
            ...
            case "get" :
                ...
                // h::log( 'Get Tracker: '.self::$template_tracker );
    ...
    public static function filter_native_templates( $array, $templates = null, $class = null ){
        ...
        // h::log( 'we have '.count( self::$native_templates ).' native templates to add' );
    ...
    public static function get_default_template( $template )
    {
        ...
        $template =  
            h::get( 'ui/view/'.self::$default_template, 'return', 'path' ) ? 
            self::$default_template = h::get( 'ui/view/'.self::$default_template, 'return', 'path' ) : 
            $template ;
    ...
    */
    public static function add_native_templates( $template ) {
        ...
        foreach( self::$native_templates as $key => $item ) {
            ...
            if ( 
                $template = h::get( 'ui/view/'.$item["template"], 
                    'return', 
                    'path',
                    'library/', // standard base library path ##
                    $class // variable class ##
