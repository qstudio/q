...
class media extends ui\wordpress {
    ...
    public static function get_gallery( $args = array() )
    {
        ...
        // open wrapping tag ##
        ui\markup::get_tag( $args->tag, array ( $args->class ) );
        ...
        foreach ( $gallery as $image ) {
            ...
            // tag_node + class ##
            ui\markup::get_tag( $args->tag_node, array ( $args->class_node ) );
...
<?php
            ...
            // tag_node + class ##
            ui\markup::get_tag( $args->tag_node, '', 'close' );

        }

        // close wrapping tag ##
        ui\markup::get_tag( $args->tag, '', 'close' );
