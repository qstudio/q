...
class callback extends \q\render {
    ...
    public static function field( String $field = null, $value = null ){
        ...
        $args = core\filter::apply([ 
            ...
            'filter'        => 'q/render/callback/field/before/'.$method.'/'.$field, // filter handle ##
            'return'        => $args
        ]); 
    ...
    public static function get_callbacks()
    {
        ...
        return \apply_filters( 'q/render/callbacks/get', self::$callbacks );
