    ...
    QS_Filter.prototype = {
        ...
        title: function () {
            ...
            if ( $filter_title_update === true ) {
                ...
                // get <title> tag ##
                $title = q_module.search_search+' | '+q_module.search_site_name;

                // update <title> tag ##
                document.title = $filter_title+$title;

                // get <h1> title ##
                $page_title = q_module.search_search+': <span class="bold">'+$filter_page_title+'</span>';
            ...
            // reset titles ##
                ...
                // get base title ##
                $page_title = q_module.search_search;
        ...
        reset: function () {
            ...
            $(".no-results").html(q_module.search_on_load_text).fadeIn();
