...
class fields extends module\field {
    ...
    public static function get_group_fields(){
        ...
        $array = module\field\filter::apply([ 
    ...
    public static function prepare(){
        ...
        self::$args = module\field\filter::apply([ 
        ...
        self::$fields = module\field\filter::apply([ 
            'parameters'    => [ 'fields' => self::$fields, 'args' => self::$args ], // pass ( $fields, $args ) as single array ##
        ...
        foreach ( self::$fields as $field => $value ) {
            ...
            $field = module\field\filter::apply([ 
            ...
            $value = module\field\callback::field( $field, $value );
            ...
            module\field\format::field( $field, $value );
    ...
    public static function get_callback( $field ){
        ...
        // filter ##
        $callback = module\field\filter::apply([ 
