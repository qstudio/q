...
class theme extends extension\consent {
    ...
    public static function wp_enqueue_scripts()
    {
        ...
        // Register the script ##
        \wp_register_script( 'q-consent-js', self::get_plugin_url( 'library/extension/consent/library/ui/asset/javascript/q-consent.js' ), array( 'jquery' ), self::version, true );
        ...
        wp_register_style( 'q-consent-css', self::get_plugin_url( 'library/extension/consent/library/ui/asset/scss/index.css' ), '', self::version );
