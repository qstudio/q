    ...
    class Q_Control extends Q {
        ...
        */
        ...
        public static function get_posts( $args = array() )
        {
            ...
            #pr( count( $q_query->posts ), 'posts' );
			#pr( count( $get_posts ), 'get_posts' );
            ...
            if ( $q_query->posts ) {
                ...
                foreach ( $get_posts as $post ) {
                    ...
                    switch ( $args->template ) {
                        ...
                        default;
                            ...
                            $class = '\q\q_theme\theme\view\post\post';
                    ...
                    if (
                        method_exists( $class, "the_{$args->template}_loop" )
                        ...
                        call_user_func (
                                array( $class, "the_{$args->template}_loop" )
                            ,   (array)$args_array
                        );

                    } else {

                        self::log ( "Method Missing : the_{$args->template}_loop" );
                ...
                // get sidebar ##
                if ( $args->sidebar ) \q\q_theme\theme\view\navigation\navigation::the_sidebar();

                // pagination ##
				#pr( $posts_args['posts_per_page'], 'posts_per_page' );
				#pr( $q_query->post_count, 'post_count' );
                if ( $args->pagination ) \q\q_theme\theme\view\navigation\navigation::the_pagination( array(
        ...
        public static function get_page_content( $args = array() )
        {
            ...
            $object->form_switch = get_field( 'form_switch', $the_post->ID ) ? get_field( 'form_switch', $the_post->ID ) : 'on' ;
        ...
        public static function get_post_thumbnail( $args = array() )
        {
            ...
            // show small image, linking to larger image ##
            $object->src = wp_get_attachment_image_src( get_post_thumbnail_id( $the_post->ID ), $args->handle );
